...
class ASRConvCTCModel(NeMoModel):
    ...
    def from_pretrained(
        ...
        if new_vocab is None:
            ...
            # 1091224
            logging.info(instance._app_state.modules.summary())
            for i,j in zip(instance._app_state.modules, instance._app_state.modules.data):
                if str(i) == 'JasperDecoderForCTC':
                    logging.info("remove the old decoder")
                    instance._app_state.modules.data.remove(j)
                    break
            # 1091224
            ...
            logging.info(instance._app_state.modules.summary())# 1091224
            return instance
